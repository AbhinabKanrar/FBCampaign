...
<div class="col-md-2   text-center">
   <div class="btn-success">Select Date</div>
 </div>
</script>


<script id="campaign-insight-template" type="text/x-handlebars-template">
		<div class="row well ">
